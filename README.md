...
# 2020 May 4th
Octree implemented. Speedup of around 400%. But a few small holes appeared in the human model. Suspecting that when the Octree regions get too small, none of the three verts in a triangle is inside.
...
# 2020 May 5th
Implemented rectangle or rather parallelogram lights with random sampling.

![Alt text](media/soft_shadows2.png?raw=true "Soft shadows")
![Alt text](media/soft_shadows.png?raw=true "Soft shadows")
